...
while True:
    ...
    url = f"https://www.sustainalytics.com/esg-research/search/{page_number}?indexCatalogue=resource-center-blog-posts&searchQuery=Environmental%20Sustainability&orderBy=Relevance"
